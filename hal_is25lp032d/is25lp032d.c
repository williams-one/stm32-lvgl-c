...
// /* Includes ------------------------------------------------------------------*/
// #include <hal_is25lp032d/mx66uw1g45g.h>
...
int32_t IS25LP032D_ResetChip(void)
{
	...
	s_command.Instruction        = IS25LP032D_RESET_ENABLE_CMD;
	...
	s_command.InstructionDtrMode = HAL_OSPI_INSTRUCTION_DTR_DISABLE;
	s_command.InstructionSize    = HAL_OSPI_INSTRUCTION_8_BITS;
	s_command.Instruction        = IS25LP032D_RESET_EXECUTE_CMD;
	s_command.AddressMode        = HAL_OSPI_ADDRESS_NONE;
	s_command.AlternateBytesMode = HAL_OSPI_ALTERNATE_BYTES_NONE;
	s_command.DataMode           = HAL_OSPI_DATA_NONE;
	s_command.DummyCycles        = 0U;
...
int32_t IS25LP032D_AutoPollingMemReady(uint32_t tout)
{
  ...
  s_command.InstructionDtrMode = HAL_OSPI_INSTRUCTION_DTR_DISABLE;
  s_command.InstructionSize    = HAL_OSPI_INSTRUCTION_8_BITS;
  s_command.Instruction        = IS25LP032D_READ_STATUS_REG_CMD;
  s_command.AddressMode        = HAL_OSPI_ADDRESS_NONE;
  ...
  if (HAL_OSPI_AutoPolling(&hospi1, &s_config, tout) != HAL_OK)
  {
    return HAL_ERROR;
  }
...
int32_t IS25LP032D_ConfigureMemory(void)
{
  ...
  s_command.InstructionDtrMode = HAL_OSPI_INSTRUCTION_DTR_DISABLE;
  s_command.InstructionSize    = HAL_OSPI_INSTRUCTION_8_BITS;
  s_command.Instruction        = IS25LP032D_WRITE_STATUS_REG_CMD;
  s_command.AddressMode        = HAL_OSPI_ADDRESS_NONE;
  s_command.AddressDtrMode     = HAL_OSPI_ADDRESS_DTR_DISABLE;
  s_command.AddressSize        = HAL_OSPI_ADDRESS_32_BITS;
  s_command.Address            = 0U;
...
int32_t IS25LP032D_EnableMemoryMappedMode(void)
{
  ...
  s_command.InstructionDtrMode = HAL_OSPI_INSTRUCTION_DTR_DISABLE;
  s_command.InstructionSize    = HAL_OSPI_INSTRUCTION_8_BITS;
  s_command.Instruction        = IS25LP032D_QUAD_OUT_FAST_READ_CMD;
  ...
  s_command.DataDtrMode        = HAL_OSPI_DATA_DTR_DISABLE;
  s_command.DummyCycles        = IS25LP032D_DUMMY_CLOCK_CYCLES_READ_QUAD;
  s_command.DQSMode            = HAL_OSPI_DQS_DISABLE;
  s_command.SIOOMode           = HAL_OSPI_SIOO_INST_EVERY_CMD;
...
int32_t IS25LP032D_WriteEnable(void)
{
  ...
  s_command.InstructionDtrMode = HAL_OSPI_INSTRUCTION_DTR_DISABLE;
  s_command.InstructionSize    = HAL_OSPI_INSTRUCTION_8_BITS;
  s_command.Instruction        = IS25LP032D_WRITE_ENABLE_CMD;
  s_command.AddressMode        = HAL_OSPI_ADDRESS_NONE;
  s_command.AlternateBytesMode = HAL_OSPI_ALTERNATE_BYTES_NONE;
  s_command.DataMode           = HAL_OSPI_DATA_NONE;
  s_command.DummyCycles        = 0U;
